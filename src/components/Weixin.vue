 ...
 * @LastEditTime: 2020-12-03 16:40:39
 * @FilePath: /giftBag/src/components/weixin.vue
-->

<template>
  <div>
    <div  class="weixin-tip" style="position: fixed; left:0; top:0; bottom:0; background: rgba(0,0,0,0.8); filter:alpha(opacity=80);  height: 100%; width: 100%; z-index: 99999999;">
